...
/* Inner components */
const Input = ({value,handleChange,name,...params}) => (
  <input 
  {...params} 
  step={"0.00001"} 
  value={value} 
...
const Welcome = () => { 
  const {connectWallet,CurrentAccount,setFormData,FormData,handleChange,sendTransaction,isLoading} = useContext(TransactionContext);
  /* My function */
        ...
        justify-between md:p-20 py-12 px-4">
            <div className="flex flex-1 justify-start flex-col mf:mr-10">
                  <h1 className={`text-3xl sm:text-5xl text-white text-gradient py-1`}>
                      Send Crypto <br/> acros the world
                  </h1>
                  <p className="text text-left mt-5 text-white 
